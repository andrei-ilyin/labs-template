...
C++17 имеется частичная поддержка. 
Если очень нужен С++17 в Яндекс.Контесте, то используйте GNU C++ Compiler.
В своё время мы сделали выбор впользу более старого Clang потому, что там 
санитайзеры работают лучше, отлавливают больше багов (как показал опыт).

Обращаем внимание, что для компилции с Clang в ЯКонтесте следует изменить 
